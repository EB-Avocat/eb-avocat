...
import { formatPublicationDate, leadCategory, type Publication } from "@/lib/publications-parse";
...
export function PublicationCard({ publication }: { publication: Publication }) {
	const { slug, title, summary, categories, date, cover, coverAlt, author } = publication;
	const category = leadCategory(categories);
